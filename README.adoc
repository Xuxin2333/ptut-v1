...
| 27/05   | CdC V1 final | link:doc/Cahier-De-Charges-v1.adoc[CdC.adoc]     | Si ce n'est pas le même que le CDC V1 (du 26) attention aux liens! Merci pour le passage à Asciidoc :-)
|         | Gantt V1-3  | link:doc/gantt-v1/Gantt-v1-Final.pdf[PDF Gantt]   | (comme vous avez fait pour celui-là)
| 28/05   | CdC V2 final |    |
|         | Gantt V2    |          |             
|         | Doc. Util. V1 |             |          
|         | Doc. Tec. V1 |                   |    
